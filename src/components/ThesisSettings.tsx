...
interface ThesisSettingsProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onReconfigure: () => void;
}

export function ThesisSettings({ open, onOpenChange, onReconfigure }: ThesisSettingsProps) {
  const [thesis, setThesis] = useState<FundThesis | null>(null);
