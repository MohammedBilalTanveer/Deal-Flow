...
export function LogoScroll() {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-50 via-white to-purple-50 border-y border-slate-200 py-6">
      ...
      <div className="overflow-hidden w-full">
        <div className="flex gap-12 px-6 animate-scroll" style={{ width: "max-content" }}>
