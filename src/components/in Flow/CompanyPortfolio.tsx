...
import { ArrowLeft, TrendingUp, DollarSign, Users, Building2, Target, AlertTriangle, CheckCircle2, FileText, Download, Share2, Plus, ThumbsUp, ThumbsDown, Sparkles } from "lucide-react";
...
export function CompanyPortfolio({ onClose }: CompanyPortfolioProps) {
  const [recommendation, setRecommendation] = useState<"pass" | "review" | "invest" | null>(null);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-slate-200">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-white flex-shrink-0">
                    SK
                  </div>
                  <div className="flex-1">
