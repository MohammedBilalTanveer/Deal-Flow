...
interface SelectRecipientsPageProps {
  onClose: () => void;
  onBack: () => void;
  dealName: string;
}
...
export function SelectRecipientsPage({ onClose, onBack, dealName }: SelectRecipientsPageProps) {
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        <Checkbox
                          ...
                          onCheckedChange={() => toggleRecipient(recipient.id)}
                        />
                        <div className="w-12 h-12 bg-gradient-to-br from-slate-400 to-slate-600 rounded-full flex items-center justify-center text-white flex-shrink-0">
                          {recipient.avatar}
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-1">
