...
interface FundThesisOnboardingProps {
  onComplete: (thesis: FundThesis) => void;
}
...
export function FundThesisOnboarding({ onComplete }: FundThesisOnboardingProps) {
  const [currentStep, setCurrentStep] = useState(1);
  const [thesis, setThesis] = useState<FundThesis>({
    investmentStage: [],
    checkSize: '',
    geography: [],
    sectors: [],
  ...
  const toggleArrayItem = (key: keyof FundThesis, value: string) => {
    const currentArray = thesis[key] as string[];
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <TrendingUp className="mx-auto size-12 text-blue-600" />
              <h2>What investment stages do you focus on?</h2>
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <DollarSign className="mx-auto size-12 text-green-600" />
              <h2>Tell us about your fund size and check size</h2>
            </div>
      ...
      case 3:
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <Globe className="mx-auto size-12 text-purple-600" />
              <h2>What geographies do you invest in?</h2>
              <p className="text-muted-foreground">Select all that apply</p>
            </div>
            <div className="space-y-3">
              {[
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <Target className="mx-auto size-12 text-orange-600" />
              <h2>Which sectors are you most interested in?</h2>
              <p className="text-muted-foreground">Select all that apply</p>
            </div>
            <div className="space-y-3">
              {[
      ...
      case 5:
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <Sparkles className="mx-auto size-12 text-yellow-600" />
              <h2>What key metrics matter most to you?</h2>
              <p className="text-muted-foreground">Select your top priorities</p>
            </div>
            <div className="space-y-3">
              {[
                'Revenue Growth Rate',
      ...
      case 6:
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <Users className="mx-auto size-12 text-red-600" />
              <h2>What are your deal breakers?</h2>
              <p className="text-muted-foreground">Select all that apply</p>
            </div>
            <div className="space-y-3">
              {[
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="mb-8 text-center">
          <h1 className="mb-2">Configure Your Fund Thesis</h1>
